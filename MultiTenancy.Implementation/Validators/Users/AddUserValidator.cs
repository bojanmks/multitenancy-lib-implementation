...
{
    public class AddUserValidator : AbstractValidator<AddUserUseCase>
    {
        public AddUserValidator(ShopDbContext context, IApplicationActor actor)
        {
            When(x => actor is IApplicationSuperUserGlobal, () =>
            {
                RuleFor(x => x.Data.Email)
                    ...
                    .Must((useCase, email) => !context.Users.Any(x => x.Email == email && x.TenantId == useCase.Data.TenantId))
            ...
            When(x => actor is IApplicationSuperUserGlobal, () =>
            {
                RuleFor(x => x.Data.Username)
                    ...
                    .Must((useCase, username) => !context.Users.Any(x => x.Username == username && x.TenantId == useCase.Data.TenantId))
